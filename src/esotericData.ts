...
export const ESOTERIC_DATA: {
  ...
  numerology: {
    ...
    // Karmic debt numbers (source: `context/knowledge_banks/karmic_bank.md`)
    "13": { subtitle: "Karmic Debt 13/4", description: "Obstruction — every task feels like an uphill battle. The correction is focus, order, and patient work without cutting corners." },
    "14": { subtitle: "Karmic Debt 14/5", description: "Instability — changing circumstances, temptation, and commitment phobia. The correction is temperance: moderation and structure." },
    "16": { subtitle: "Karmic Debt 16/7", description: "The Tower — ego collapse and repeated resets. The correction is humility and rebuilding on a spiritual foundation." },
    "19": { subtitle: "Karmic Debt 19/1", description: "Isolation — forced to stand alone. The correction is interdependence: accepting help and leading with compassion." },
  },
  tarot: {
  ...
  chineseZodiac: {
    Rat: { description: "Clever, adaptable, and first in the cycle. The Rat finds a way where others see walls. Charm and resourcefulness are your gifts; greed and anxiety your shadows. Fixed Element: Water (Yang). Hour Pillar: 23:00–01:00." },
    Ox: { description: "Steady, strong, and dependable. The Ox carries the weight of the world without complaint. Endurance and loyalty are your gifts; stubbornness your shadow. Fixed Element: Earth (Yin). Hour Pillar: 01:00–03:00." },
    Tiger: { description: "Bold, charismatic, and fierce. The Tiger commands attention and takes risks. Courage and passion are your gifts; recklessness your shadow. Fixed Element: Wood (Yang). Hour Pillar: 03:00–05:00." },
    Rabbit: { description: "Gentle, diplomatic, and intuitive. The Rabbit moves through conflict with grace. Sensitivity and refinement are your gifts; avoidance your shadow. Soft does not mean weak. Fixed Element: Wood (Yin). Hour Pillar: 05:00–07:00." },
    Dragon: { description: "Charismatic, ambitious, and larger than life. The Dragon brings luck and transformation. Power and vision are your gifts; arrogance your shadow. Fixed Element: Earth (Yang). Hour Pillar: 07:00–09:00." },
    Snake: { description: "Wise, enigmatic, and transformative. The Snake sheds the old and emerges renewed. Depth and intuition are your gifts; secrecy your shadow. Reveal when it serves; protect when it matters. Fixed Element: Fire (Yin). Hour Pillar: 09:00–11:00." },
    Horse: { description: "Free-spirited, energetic, and independent. The Horse runs toward the horizon. Freedom and passion are your gifts; restlessness your shadow. Run—but know where home is. Fixed Element: Fire (Yang). Hour Pillar: 11:00–13:00." },
    Goat: { description: "Creative, gentle, and aesthetic. The Goat seeks beauty and peace. Art and empathy are your gifts; passivity your shadow. Create the world you want to live in. Fixed Element: Earth (Yin). Hour Pillar: 13:00–15:00." },
    Monkey: { description: "Clever, playful, and inventive. The Monkey solves problems with wit. Ingenuity and humor are your gifts; mischief your shadow. Play—but play for the right reasons. Fixed Element: Metal (Yang). Hour Pillar: 15:00–17:00." },
    Rooster: { description: "Proud, observant, and precise. The Rooster announces the dawn. Honesty and diligence are your gifts; criticality your shadow. Speak the truth with kindness. Fixed Element: Metal (Yin). Hour Pillar: 17:00–19:00." },
    Dog: { description: "Loyal, honest, and protective. The Dog guards what matters. Fidelity and justice are your gifts; worry your shadow. Protect—but do not imprison. Fixed Element: Earth (Yang). Hour Pillar: 19:00–21:00." },
    Pig: { description: "Generous, sincere, and devoted to pleasure. The Pig enjoys the feast of life. Abundance and warmth are your gifts; overindulgence your shadow. Give freely; receive with grace. Fixed Element: Water (Yin). Hour Pillar: 21:00–23:00." },
  },
  chineseElement: {
    Metal: { description: "Clarity, precision, and the edge that cuts. Metal refines and structures. You value order, truth, and the removal of what does not serve. Shadow: rigidity. (Soul Tone P=2.0)" },
    Water: { description: "Depth, flow, and the power of adaptation. Water shapes to the vessel. You move through obstacles by yielding. Shadow: overwhelm. (Soul Tone P=1.2)" },
    Wood: { description: "Growth, expansion, and the push toward light. Wood reaches and spreads. You build, create, and nurture. Shadow: overextension. (Soul Tone P=0.8)" },
    Fire: { description: "Passion, transformation, and radiant energy. Fire consumes and illuminates. You inspire and destroy in turn. Shadow: burnout. (Soul Tone P=0.5)" },
    Earth: { description: "Stability, nourishment, and the center. Earth holds and sustains. You are the anchor and the harvest. Shadow: stagnation. (Soul Tone P=1.5)" },
  },
  planetaryRuler: {
    Sun: { description: "Vitality, identity, and the core self. The Sun rules the day you were born—your essential radiance. You are here to shine and to lead from the heart. Shadow: ego. (f₀=126.22Hz)" },
    Moon: { description: "Emotion, instinct, and the inner tide. The Moon rules your emotional nature and your need for security. You feel deeply and protect what you love. Shadow: mood. (f₀=210.42Hz)" },
    Mars: { description: "Action, desire, and the will to fight. Mars rules your drive and how you assert yourself. You are built for courage and conquest. Shadow: rage. (f₀=144.72Hz)" },
    Mercury: { description: "Mind, communication, and the messenger. Mercury rules how you think, speak, and connect. You are the bridge between ideas and people. Shadow: restlessness. (f₀=141.27Hz)" },
    Jupiter: { description: "Expansion, wisdom, and luck. Jupiter rules growth, meaning, and the search for truth. You are here to learn and to teach. Shadow: excess. (f₀=183.58Hz)" },
    Venus: { description: "Love, beauty, and value. Venus rules your heart, your aesthetics, and what you hold dear. You attract and create harmony. Shadow: indulgence. (f₀=221.23Hz)" },
    Saturn: { description: "Structure, discipline, and time. Saturn rules limits, responsibility, and the long game. You build what lasts through effort. Shadow: fear. (f₀=147.85Hz)" },
  },
  moonPhase: {
  ...
  celticTree: {
    ...
    Mistletoe: { subtitle: "The Nameless Day", description: "Outside of time. A wild-card cusp (Dec 23) — pure potential, liminality, and the shaman’s zero-point between endings and beginnings." },
  },
};
